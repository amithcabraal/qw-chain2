...
function App() {
  ...
  // Fetch missed word definition when game is over
  useEffect(() => {
          ...
          <main className="flex flex-col items-center gap-6">
            {currentPage === 'game' ? (
              loading && !gameState.gameOver ? (
                <div className="text-emerald-900 dark:text-emerald-100">Loading...</div>
              ) : !gameState.gameOver ? (
                <>
                  {getCurrentWord() && (
                    <WordDisplay 
              ...
              <StaticPage title="How to Play">
                <p>QuizWordz Chain is a word association game where you build a chain of related words:</p>
                <ol>
                ...
                <p>The game ends when you either:</p>
                <ul>
              ...
              <StaticPage title="Contact Us">
                <p>Have questions or feedback about QuizWordz Chain? We'd love to hear from you!</p>
                <p>Email us at: support@quizwordz.com</p>
              </StaticPage>
            ) : (
              <StaticPage title="Privacy Policy">
                <h3>Data Collection</h3>
                <p>We only store your game history locally on your device. No personal information is collected or transmitted.</p>
                <h3>Cookies</h3>
